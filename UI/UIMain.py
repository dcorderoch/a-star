...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnLoadFile = QPushButton(self.centralwidget)
        self.btnLoadFile.setObjectName(u"btnLoadFile")
        self.btnLoadFile.setGeometry(QRect(330, 730, 111, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnLoadFile.setText(QCoreApplication.translate("MainWindow", u"Cargar Archivo", None))
        self.btnLoadFile.clicked.connect(self.btnLoadFileHandler)
    # retranslateUi
